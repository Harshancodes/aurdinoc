#include <stdio.h>
char turn;
int p1,p2,s,b2=0,b3=0,b4=0,b5=0;
int i, j,r,c,x,y,b6=0,b7=0,b8=0,b9=0;
char a1[3][3];
char a2[3][3];
char a3[3][3];
char a4[3][3];
